...
1.  Create `master_countries` dataframe
    ...
    2.  Filter for `shifting`, `moribund`, and `endangered` AES statuses
    3.  Filter for years \>= 2005 for GDP and Population data
...
1.  The highest concentration of `shifting` languages will be in countries/areas that have seen the largest decline in population over the last 20 years.
...
|:------:|:--------------------------------------:|:-------------:|:-----------:|
| Week 1 |        Proposal + Peer Reviews         | June 17, 2026 |  Complete   |
| Week 2 |       Data Wrangling + Mutation        | June 25, 2026 | In Progress |
| Week 3 |     Visualizations + Begin Writeup     | July 1, 2026  | In Progress |
| Week 4 | Complete Writeup + Record Presentation | July 3, 2026  | In Progress |
